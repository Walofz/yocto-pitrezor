...
EXTRA_OECMAKE = "-DWAVESHARE_ST7735S_HAT=ON -DSPI_BUS_CLOCK_DIVISOR=30 -DSTATISTICS=0 -DDISPLAY_BREAK_ASPECT_RATIO_WHEN_SCALING=ON -DDISPLAY_ROTATE_180_DEGREES=OFF -DSINGLE_CORE_BOARD=ON -DUSE_DMA_TRANSFERS=OFF"
